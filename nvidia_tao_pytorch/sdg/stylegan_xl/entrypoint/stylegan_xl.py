...
"""Define entrypoint to run tasks for StyleGAN-XL."""

import argparse

from nvidia_tao_pytorch.sdg.stylegan_xl import scripts
...
def main():
    ...
    parser = argparse.ArgumentParser(
        "stylegan_xl",
        add_help=True,
        description="Train Adapt Optimize entrypoint for stylegan_xl"
    )
    ...
    # Launch the subtask.
    launch(vars(args), unknown_args, subtasks, network="stylegan_xl")
