...
static torch::Tensor upfirdn2d(torch::Tensor x, torch::Tensor f, int64_t upx, int64_t upy, int64_t downx, int64_t downy, int64_t padx0, int64_t padx1, int64_t pady0, int64_t pady1, bool flip, double gain)
{
    // Validate arguments.
...
static auto registry_upfirdn2d = torch::RegisterOperators("nvidia::upfirdn2d", &upfirdn2d);
