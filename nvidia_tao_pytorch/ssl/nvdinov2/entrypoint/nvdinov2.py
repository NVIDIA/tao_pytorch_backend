...
"""Define entrypoint to run tasks for nvdinov2."""

import argparse
from nvidia_tao_pytorch.ssl.nvdinov2 import scripts
...
def main():
    ...
    parser = argparse.ArgumentParser(
        "nvdinov2",
        add_help=True,
        description="Train Adapt Optimize entrypoint for nvdinov2"
    )
