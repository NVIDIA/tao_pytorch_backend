...
def main():
    ...
    parser = argparse.ArgumentParser(
        "mae", add_help=True, description="Train Adapt Optimize entrypoint for Mask Auto Encoder"
    )
