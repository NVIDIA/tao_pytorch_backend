...
from nvidia_tao_pytorch.ssl.mae.utils.pos_embed import get_2d_sincos_pos_embed
...
class MaskedAutoencoderViT(nn.Module):
    ...
    def forward_loss(self, imgs, pred, mask):
        ...
        Args:
            imgs (tensor): [N, 3, H, W]
            pred (tensor): [N, L, p*p*3]
            mask (tensor): [N, L], 0 is keep, 1 is remove
        """
...
mae_vit_group = [mae_vit_base_patch16, mae_vit_large_patch16, mae_vit_huge_patch14]
