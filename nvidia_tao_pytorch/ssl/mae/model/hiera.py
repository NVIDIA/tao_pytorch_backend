...
class Hiera(nn.Module):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        assert q_pool < len(stages), "Number of q_pool should be less than the number of stages."
...
hiera_group = [hiera_tiny_224, hiera_small_224, hiera_base_224, hiera_large_224, hiera_huge_224]
