...
class ViTAdapter(TIMMVisionTransformer):
    ...
    def __init__(self, *args, pretrain_size=224, num_heads=12, conv_inplane=64, n_points=4,
                 ...
                 use_extra_extractor=True, out_indices=[0, 1, 2, 3], activation_checkpoint=False, **kwargs):
...
def vit_large_nvdinov2(out_indices=[0, 1, 2, 3], resolution=1024, activation_checkpoint=False, **kwargs):
...
def vit_large_dinov2(out_indices=[0, 1, 2, 3], resolution=1024, activation_checkpoint=False, **kwargs):
