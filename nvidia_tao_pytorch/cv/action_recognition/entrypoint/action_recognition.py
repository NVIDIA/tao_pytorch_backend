...
"""Define entrypoint to run tasks for action_recognition."""

import argparse
from nvidia_tao_pytorch.cv.action_recognition import scripts
...
def main():
    ...
    parser = argparse.ArgumentParser(
        "action_recognition",
        add_help=True,
        description="Train Adapt Optimize entrypoint for action_recognition",
    )
    ...
    # Launch the subtask.
    launch(vars(args), unknown_args, subtasks, network="action_recognition")
