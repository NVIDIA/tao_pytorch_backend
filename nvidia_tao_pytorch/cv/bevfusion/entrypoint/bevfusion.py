...
"""'Entry point' script running subtasks related to BEVFusion."""

import argparse

from nvidia_tao_pytorch.core.entrypoint import get_subtasks, launch, command_line_parser
from nvidia_tao_pytorch.cv.bevfusion import scripts
...
def main():
    ...
    parser = argparse.ArgumentParser(
        "bevfusion",
        add_help=True,
        description="Train Adapt Optimize entrypoint for bevfusion",
    )
    ...
    # Launch the subtask.
    launch(vars(args), unknown_args, subtasks, network="bevfusion")
