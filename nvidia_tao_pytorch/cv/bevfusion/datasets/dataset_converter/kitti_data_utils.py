...
""" BEVFusion kitti-person converter helper functions. """

from collections import OrderedDict
from concurrent import futures as futures_import
...
def get_label_anno(label_path):
    ...
    # dimensions will convert hwl format to standard lhw(camera) format. yzx -> xyz
...
def get_kitti_image_info(path,
    ...
    with futures_import.ThreadPoolExecutor(num_worker) as executor:
