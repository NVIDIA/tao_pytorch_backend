...
"""BEVFusion scatter ops functions"""
...
class DynamicScatter(nn.Module):
    ...
    def forward(self, points, coors):
        ...
        """
        if coors.size(-1) == 3:
            output = self.forward_single(points, coors)
        else:
