...
class PositionEncodingLearned(nn.Module):
    ...
    def __init__(self, input_channel, num_pos_feats=288):
        """Init Learnable Position Encoding """
        super().__init__()
    ...
    def forward(self, xyz):
        """Forward function for PositionEncodingLearned """
...
class TransformerDecoderLayer(DetrTransformerDecoderLayer):
    ...
    def __init__(self,
        ...
        Args:
            pos_encoding_cfg (Dict): Position Encoding parameters
        """
