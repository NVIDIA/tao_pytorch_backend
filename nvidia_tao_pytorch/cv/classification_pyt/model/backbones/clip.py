...
class OpenClip(nn.Module):
    ...
    Args:
        ...
        freeze (bool): Freeze the model weights.
        model_cfg (dict): The model configuration. if None, the default configuration from open_clip will be used.
        init_cfg (dict): The initialization configuration. {checkpoint (str): The path to the checkpoint to load.}
    """
    ...
    def __init__(self, model_name="ViT-B-32", freeze=False, model_cfg=None, init_cfg=None, **kwargs):
        ...
        if init_cfg:
            ...
            _tmp_st_output = self.model.load_state_dict(model, strict=False)
