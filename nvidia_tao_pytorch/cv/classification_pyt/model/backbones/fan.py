...
class FanTiny12P16224(FAN):
    ...
    def __init__(self, **kwargs):
        ...
        super(FanTiny12P16224, self).__init__(**model_kwargs)


class FanSmall12P16224SeAttn(FAN):
    """ FAN Small SE ViT """
    ...
    def __init__(self, **kwargs):
        ...
        super(FanSmall12P16224SeAttn, self).__init__(**model_kwargs)


class FanSmall12P16224(FAN):
    """ FAN Small ViT """
    ...
    def __init__(self, **kwargs):
        ...
        super(FanSmall12P16224, self).__init__(**model_kwargs)


class FanBase18P16224(FAN):
    """ FAN Base ViT """
    ...
    def __init__(self, **kwargs):
        ...
        super(FanBase18P16224, self).__init__(**model_kwargs)


class FanLarge24P16224(FAN):
    """ FAN Large ViT """
    ...
    def __init__(self, **kwargs):
        ...
        super(FanLarge24P16224, self).__init__(**model_kwargs)
...
class FanTiny8P4Hybrid(FAN):
    ...
    def __init__(self, **kwargs):
        ...
        super(FanTiny8P4Hybrid, self).__init__(**model_kwargs)


class FanSmall12P4Hybrid(FAN):
    """ FAN Small Hybrid """
    ...
    def __init__(self, **kwargs):
        ...
        super(FanSmall12P4Hybrid, self).__init__(**model_kwargs)


class FanBase16P4Hybrid(FAN):
    """ FAN Base Hybrid """
    ...
    def __init__(self, **kwargs):
        ...
        super(FanBase16P4Hybrid, self).__init__(**model_kwargs)


class FanLarge16P4Hybrid(FAN):
    """ FAN Large Hybrid """
    ...
    def __init__(self, **kwargs):
        ...
        super(FanLarge16P4Hybrid, self).__init__(**model_kwargs)


class FanXlarge16P4Hybrid(FAN):
    """FAN XLarge hybrid"""
    ...
    def __init__(self, **kwargs):
        ...
        super(FanXlarge16P4Hybrid, self).__init__(**model_kwargs)
