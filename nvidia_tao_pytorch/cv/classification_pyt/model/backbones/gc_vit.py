...
class GcVitXxtiny(GCViT):
    ...
    def __init__(self, **kwargs):
        ...
        model_kwargs = dict(depths=[2, 2, 6, 2],
                            ...
                            drop_path_rate=0.2,
                            **kwargs)
        super(GcVitXxtiny, self).__init__(**model_kwargs)


class GcVitXtiny(GCViT):
    """GCViT-XTiny model."""
    ...
    def __init__(self, **kwargs):
        ...
        model_kwargs = dict(depths=[3, 4, 6, 5],
                            ...
                            drop_path_rate=0.2,
                            **kwargs)
        super(GcVitXtiny, self).__init__(**model_kwargs)


class GcVitTiny(GCViT):
    """GCViT-Tiny model."""
    ...
    def __init__(self, **kwargs):
        ...
        model_kwargs = dict(depths=[3, 4, 19, 5],
                            ...
                            drop_path_rate=0.2,
                            **kwargs)
        super(GcVitTiny, self).__init__(**model_kwargs)


class GcVitSmall(GCViT):
    """GCViT-Small model."""
    ...
    def __init__(self, **kwargs):
        ...
        model_kwargs = dict(depths=[3, 4, 19, 5],
                            ...
                            layer_scale=1e-5,
                            **kwargs)
        super(GcVitSmall, self).__init__(**model_kwargs)


class GcVitBase(GCViT):
    """GCViT-Base model."""
    ...
    def __init__(self, **kwargs):
        ...
        model_kwargs = dict(depths=[3, 4, 19, 5],
                            ...
                            layer_scale=1e-5,
                            **kwargs)
        super(GcVitBase, self).__init__(**model_kwargs)


class GcVitLarge(GCViT):
    """GCViT-Large model."""
    ...
    def __init__(self, **kwargs):
        ...
        model_kwargs = dict(depths=[3, 4, 19, 5],
                            ...
                            layer_scale=1e-5,
                            **kwargs)
        super(GcVitLarge, self).__init__(**model_kwargs)


class GcVitLarge384(GCViT):
    ...
    def __init__(self, **kwargs):
        ...
        model_kwargs = dict(depths=[3, 4, 19, 5],
                            ...
                            layer_scale=1e-5,
                            **kwargs)
        super(GcVitLarge384, self).__init__(**model_kwargs)
