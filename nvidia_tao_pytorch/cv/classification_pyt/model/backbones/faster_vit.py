...
class FasterViT(nn.Module):
    ...
    def __init__(self,
        ...
        Args:
            ...
            init_cfg: initialization config, consist of checkpoint path.
        """
        ...
        if init_cfg and init_cfg.get("checkpoint"):
            ...
            self.load_state_dict(checkpoint=pretrained)
...
class FasterVit0224(FasterViT):
    ...
    def __init__(self, **kwargs):
        ...
        model_kwargs = dict(depths=[2, 3, 6, 5],
                            ...
                            hat=[False, False, True, False],
                            **kwargs)
        super(FasterVit0224, self).__init__(**model_kwargs)


class FasterVit1224(FasterViT):
    """FasterViT-1 model."""
    ...
    def __init__(self, **kwargs):
        ...
        model_kwargs = dict(depths=[1, 3, 8, 5],
                            ...
                            hat=[False, False, True, False],
                            **kwargs)
        super(FasterVit1224, self).__init__(**model_kwargs)


class FasterVit2224(FasterViT):
    """FasterViT-2 model."""
    ...
    def __init__(self, **kwargs):
        ...
        model_kwargs = dict(depths=[3, 3, 8, 5],
                            ...
                            hat=[False, False, True, False],
                            **kwargs)
        super(FasterVit2224, self).__init__(**model_kwargs)


class FasterVit3224(FasterViT):
    """FasterViT-3 model."""
    ...
    def __init__(self, **kwargs):
        ...
        model_kwargs = dict(depths=[3, 3, 12, 5],
                            ...
                            hat=[False, False, True, False],
                            **kwargs)
        super(FasterVit3224, self).__init__(**model_kwargs)


class FasterVit4224(FasterViT):
    """FasterViT-4 model."""
    ...
    def __init__(self, **kwargs):
        ...
        model_kwargs = dict(depths=[3, 3, 12, 5],
                            ...
                            hat=[False, False, True, False],
                            **kwargs)
        super(FasterVit4224, self).__init__(**model_kwargs)


class FasterVit5224(FasterViT):
    """FasterViT-5 model."""
    ...
    def __init__(self, **kwargs):
        ...
        model_kwargs = dict(depths=[3, 3, 12, 5],
                            ...
                            hat=[False, False, True, False],
                            **kwargs)
        super(FasterVit5224, self).__init__(**model_kwargs)


class FasterVit6224(FasterViT):
    """FasterViT-6 model."""
    ...
    def __init__(self, **kwargs):
        ...
        model_kwargs = dict(depths=[3, 3, 16, 8],
                            ...
                            hat=[False, False, True, False],
                            **kwargs)
        super(FasterVit6224, self).__init__(**model_kwargs)


class FasterVit421k224(FasterViT):
    ...
    def __init__(self, **kwargs):
        ...
        model_kwargs = dict(depths=[3, 3, 12, 5],
                            ...
                            **kwargs)
        super(FasterVit421k224, self).__init__(**model_kwargs)


class FasterVit421k384(FasterViT):
    ...
    def __init__(self, **kwargs):
        ...
        model_kwargs = dict(depths=[3, 3, 12, 5],
                            ...
                            hat=[False, False, False, False],
                            **kwargs)
        super(FasterVit421k384, self).__init__(**model_kwargs)


class FasterVit421k512(FasterViT):
    ...
    def __init__(self, **kwargs):
        ...
        model_kwargs = dict(depths=[3, 3, 12, 5],
                            ...
                            hat=[False, False, False, False],
                            **kwargs)
        super(FasterVit421k512, self).__init__(**model_kwargs)


class FasterVit421k768(FasterViT):
    ...
    def __init__(self, **kwargs):
        ...
        model_kwargs = dict(depths=[3, 3, 12, 5],
                            ...
                            hat=[False, False, False, False],
                            **kwargs)
        super(FasterVit421k768, self).__init__(**model_kwargs)
