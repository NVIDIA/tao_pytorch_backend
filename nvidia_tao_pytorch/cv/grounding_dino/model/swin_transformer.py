...
def window_reverse(windows, window_size, H, W, B):
    """Need to accept B as input to enable dynamic axes in ONNX.
    Args:
...
class SwinTransformerBlock(nn.Module):
    ...
    def forward(self, x, mask_matrix):
        ...
        shifted_x = window_reverse(attn_windows, self.window_size, Hp, Wp, B)  # B H' W' C
...
class SwinTransformer(nn.Module):
    ...
    def __init__(
        ...
        Args:
            ...
            activation_checkpoint (bool): Whether to use checkpointing to save memory. Default: False.
            dilation (bool): if True, the output size if 16x downsample, or 32x downsample.
        """
        super().__init__()
