...
"""Define entrypoint to run tasks for pose_classification."""

import argparse
from nvidia_tao_pytorch.cv.pose_classification import scripts
...
def main():
    ...
    parser = argparse.ArgumentParser(
        "pose_classification",
        add_help=True,
        description="Train Adapt Optimize entrypoint for pose_classification",
    )
    ...
    # Launch the subtask.
    launch(vars(args), unknown_args, subtasks, network="pose_classification")
