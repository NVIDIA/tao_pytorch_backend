...
# Original source taken from https://github.com/huggingface/transformers/blob/main/src/transformers/kernels/deformable_detr/cuda/ms_deform_attn_cuda.cu
    ...
    const at::Tensor &attn_weight)
{
    ...
    const int im2col_step_ = std::min(batch, (int)im2col_step);
