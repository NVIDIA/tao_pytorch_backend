...
"""Define entrypoint to run tasks for deformable_detr."""

import argparse
from nvidia_tao_pytorch.cv.deformable_detr import scripts
...
def main():
    ...
    parser = argparse.ArgumentParser(
        "deformable_detr",
        add_help=True,
        description="Train Adapt Optimize entrypoint for deformable_detr",
    )
