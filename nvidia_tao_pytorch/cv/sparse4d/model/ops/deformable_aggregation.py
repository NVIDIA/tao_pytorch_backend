...
from nvidia_tao_pytorch.cv.sparse4d.model.ops import deformable_aggregation_ext


class DeformableAggregationFunction(Function):
    """DeformableAggregationFunction class."""
...
def feature_maps_format(feature_maps, inverse=False):
    ...
    if inverse:
        ...
        num_cams, _ = spatial_shape.shape[:2]
    ...
    spatial_shape = spatial_shape.repeat(num_cams, 1, 1)
