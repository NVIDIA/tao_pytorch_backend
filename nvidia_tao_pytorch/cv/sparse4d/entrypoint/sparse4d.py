...
"""Define entrypoint to run tasks for Sparse4D."""

import argparse
from nvidia_tao_pytorch.cv.sparse4d import scripts
...
def main():
    ...
    parser = argparse.ArgumentParser(
        "sparse4d",
        add_help=True,
        description="Train Adapt Optimize entrypoint for sparse4d",
    )
    ...
    # Launch the subtask.
    launch(vars(args), unknown_args, subtasks, network="sparse4d")
