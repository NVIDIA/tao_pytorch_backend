...
"""Define entrypoint to run tasks for segformer."""

import argparse
from nvidia_tao_pytorch.cv.segformer import scripts
...
def main():
    ...
    parser = argparse.ArgumentParser(
        "segformer",
        add_help=True,
        description="Train Adapt Optimize entrypoint for segformer",
    )
