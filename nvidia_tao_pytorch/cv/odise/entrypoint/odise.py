...
"""Define entrypoint to run tasks for odise."""

import argparse
from nvidia_tao_pytorch.cv.odise import scripts
...
def main():
    ...
    parser = argparse.ArgumentParser(
        "odise",
        add_help=True,
        description="Train Adapt Optimize Deploy entrypoint for odise",
    )
    ...
    # Launch the subtask.
    launch(vars(args), unknown_args, subtasks, network="odise")
