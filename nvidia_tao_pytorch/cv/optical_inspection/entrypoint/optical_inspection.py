...
"""Define entrypoint to run tasks for optical_inspection."""

import argparse
from nvidia_tao_pytorch.cv.optical_inspection import scripts
...
def main():
    ...
    parser = argparse.ArgumentParser(
        "optical_inspection",
        add_help=True,
        description="Train Adapt Optimize entrypoint for optical_inspection",
    )
