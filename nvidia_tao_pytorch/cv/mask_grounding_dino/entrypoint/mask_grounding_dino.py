...
"""'Entry point' script running subtasks related to Mask Grounding DINO."""

import argparse

from nvidia_tao_pytorch.core.entrypoint import get_subtasks, launch, command_line_parser
import nvidia_tao_pytorch.cv.mask_grounding_dino.scripts as scripts
...
def main():
    ...
    parser = argparse.ArgumentParser(
        "mask_grounding_dino",
        add_help=True,
        description="Train Adapt Optimize entrypoint for mask_grounding_dino",
    )
